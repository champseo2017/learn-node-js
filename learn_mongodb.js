...
Delete คือ การลบ document ออกจากฐานข้อมูล ซึ้งมีอยู่ด้วยกันหลาย วิธีเช่น
 ...
 ดู documents ที่อยู่ในคอลเลกชั่นที่สนใจ

 หากต้องการดึงข้อมูลนักเรียนจากคอลเลกชั่น students มาใช้งาน เราจะใช้เมธอด findOne() เพื่อเลือกนักเรียนที่สนใจมาเพียงคนเดียว แต่ถ้าต้องการเลือกนักเรียนหลายๆ คนจะใช้เมธอด find() 

 ค้นหานักเรียนที่มีชื่อว่า Supaporn ที่อยู่ในคอลเลกชัน students โดยพิมพ์คำสั่ง db.students.findOne({name: "Supaporn"}) สังเกตว่าเราจะต้องผ่านค่าออบเจ็กต์เข้าไปยังเมธอด findOne() เพื่อกำหนดเงือนไขในการค้นหาข้อมูล
